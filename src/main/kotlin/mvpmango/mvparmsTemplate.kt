...
val MVPArmsTemplate
    get() = template {
        revision = 1
        name = "MVPMangoTemplate"
        description = "一键创建 mvpmango 单个页面所需要的全部组件"
        minApi = 9
        minBuildApi = 15
        ...
        val activityPackageName = stringParameter {
            ...
            constraints = listOf(Constraint.PACKAGE)
            suggest = { "${packageName.value}.feature.ui.activity" }
        }
        ...
        val fragmentPackageName = stringParameter {
            ...
            suggest = { "${packageName.value}.feature.ui.fragment" }
        }
        ...
        val contractPackageName = stringParameter {
            ...
            suggest = { "${packageName.value}.feature.contract" }
        }
        ...
        val presenterPackageName = stringParameter {
            ...
            suggest = { "${packageName.value}.feature.presenter" }
        }
        ...
        val modelPackageName = stringParameter {
            ...
            suggest = { "${packageName.value}.feature.model" }
        }
